...
// app.get('/view_col_right', routes.view_col_right);  /* View of individual item       */
// app.get('/view_col_left',  routes.view_col_left);

/* JSON */
app.get('/item_details',         routes.item_details);  /* View json of individual item        */
app.get('/crafting',             routes.craftHome);
app.get('/crafting/:discipline', routes.craftInfo);
